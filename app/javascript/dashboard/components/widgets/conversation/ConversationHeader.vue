...
<template>
  <div
    ...
    class="flex flex-col gap-3 items-center justify-between flex-1 w-full min-w-0 xl:flex-row px-4 sm:px-6 py-4 min-h-24 xl:min-h-20 bg-s-surface border-b border-s-border-subtle"
  >
    <div
